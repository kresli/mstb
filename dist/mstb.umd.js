(function (global, factory) {
  ...
  function Controller(Props) {
    var Store = mobxStateTree.types.model().props(Props).actions(function (self) {
      return {
  ...
  function Bundle(Base) {
    ...
    function (_Base) {
      ...
      _createClass(BundleBase, [{
        key: "$resolveIdentifier",
        value: function $resolveIdentifier(BundleType, guid) {
          var model = mobxStateTree.resolveIdentifier(BundleType.Store, this.$model, guid);
